  ...
  return (
    <div id="projects" className="bg-[#0a192f] h-screen flex flex-col justify-center gap-y-3 px-5 lg:px-[20%]">
        <div className="flex justify-start">
            <p className="text-blue-100 text-3xl font-bold py-[5px] sm:text-left border-b-[3px] border-[#01be96] inline" data-aos="fade-right">Projects</p>
        </div>
        <p className="text-blue-100 text-base text-justify sm:text-left" data-aos="fade-right">Here are some of my projects that I built using Front-End and Back-End technologies.</p>
